...
export const metadata: Metadata = {
  title: "TechVision - Enterprise IT Solutions India",
  description: "Premier Indian IT company offering cloud solutions, cybersecurity, AI, and DevOps services for global enterprises",
  keywords: "IT solutions, cloud services, cybersecurity, software development, enterprise IT, India",
  metadataBase: new URL("https://techvision.com"),
  alternates: {
    canonical: "https://techvision.com"
  },
  openGraph: {
    title: "TechVision - Transform Your Business with Enterprise IT Solutions",
    description: "India's leading IT solutions provider delivering cloud, security, and digital transformation",
    siteName: "TechVision",
    type: "website"
  },
  twitter: {
    ...
    description: "Premier IT services company in India offering cloud, security, and technology transformation"
  }
};
